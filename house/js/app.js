...
let slider_fabric = new Swiper('.fabric-selection__slider', {
	// /*
	// effect: 'fade',
	// autoplay: {
	// 	delay: 3000,
...
let slider_fabric2 = new Swiper('.fabric-selection__slider-dence', {
	// /*
	// effect: 'fade',
	// autoplay: {
	// 	delay: 3000,
...
var deadline = new Date(Date.parse(new Date()) + 12 * 60 * 60 * 1000);

initializeClock('countdown', deadline);
// Кнопка для табов
let tabsItems = document.querySelectorAll('.tabs-block__item')
let tabsBtn = document.querySelector('.value');
// console.log(tabsBtn);
...
tabsItems.forEach(e => {
	e.addEventListener('click', function () {
		...
		let value = e.querySelector('p').textContent;
		tabsBtn.innerHTML = value;
	})
});
